...
// Module: SSExactMajority.Convergence.SwapStepTimer
...
LEAN_EXPORT lean_object* initialize_SSExactMajority_SSExactMajority_Convergence_SwapStepTimer(uint8_t builtin) {
lean_object * res;
