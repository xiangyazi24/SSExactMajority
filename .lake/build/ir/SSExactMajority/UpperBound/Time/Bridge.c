...
// Module: SSExactMajority.UpperBound.Time.Bridge
...
LEAN_EXPORT lean_object* initialize_SSExactMajority_SSExactMajority_UpperBound_Time_Bridge(uint8_t builtin) {
lean_object * res;
