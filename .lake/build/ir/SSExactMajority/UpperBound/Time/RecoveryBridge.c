...
// Module: SSExactMajority.UpperBound.Time.RecoveryBridge
...
LEAN_EXPORT lean_object* initialize_SSExactMajority_SSExactMajority_UpperBound_Time_RecoveryBridge(uint8_t builtin) {
lean_object * res;
